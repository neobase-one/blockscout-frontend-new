...
const AddressEntry = (props: EntityProps) => {
  ...
  const highlightedBgColor = useColorModeValue('mediumSeaGreen.50', 'lightGreen.50');
  const highlightedBorderColor = useColorModeValue('mediumSeaGreen.200', 'lightGreen.200');
